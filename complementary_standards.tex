...
The \prov{Associations} property is OPTIONAL and MAY contain a set of \sbol{URI}s that refers to \prov{Association} objects.

\subparagraph{The \sbolheading{qualifiedUsage} property}\label{sec:prov:qualifiedUsage}
The \prov{qualifiedUsage} property is OPTIONAL and MAY contain a set of \sbol{URI}s that refers to \prov{Usage} objects.
...
\subparagraph{The \sbolheading{agent} property}\label{sec:prov:agent}
...
The \sbolmult{hadPlan}{plan} property is OPTIONAL and contains a \sbol{URI} that refers to a \prov{Plan}.
