...
Note that this means that these that the object receives both an \external{rdf:type} for the SBOL class and also an \external{rdf:type} in their own namespace.
