...
\subparagraph{The \sbolheading{types} property}\label{sec:types:Activity}
...
\subparagraph{The \sbolheading{roles} property}\label{sec:roles:U}
...
\subparagraph{The \sbolheading{roles} property}\label{sec:roles:A}
...
\subparagraph{The \sbolheading{plan} property}\label{sec:plan}
