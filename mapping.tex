...
\threezeroone{\item The SBOL 2.x \sbol{VariableComponent} class has been renamed \sbol{VariableFeature}.}
\item In \sbol{VariableComponent}, the SBOL 2.x \external{operator} property maps to the SBOL 3.x \sbol{cardinality} property.
\threezeroone{\item In \sbol{VariableComponent}, the \sbol{variantMeasure} property has been added, which does not exist in SBOL 2.x.}
