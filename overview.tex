...
There is one final critical part of SBOL 2.0, its extension mechanism.  Even with all the new classes that SBOL 2.0 provides, there is still a lot of important data that i
