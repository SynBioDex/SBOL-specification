...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.5]{images/OverviewFigforSpec-v2.png}
\caption{Main classes of information represented by the SBOL standard, and their relationships.  Red boxes are classes from the 1.1 version, while blue classes are the some of the new classes for this version of SBOL.}
