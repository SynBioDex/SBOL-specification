...
%\end{itemize}
In SBOL 3, these two classes are merged into a single object called \sbol{Component} which describes both structural and functional aspects.
