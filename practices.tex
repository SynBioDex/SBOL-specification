...
An ``atomic'' reagent, which is not expected to be divided further in designs, SHOULD be represented as a \\ \sbol{ComponentDefinition}. Examples: Arabinose, Kanamycin, Rainbow bead control
