...
\Rtodo{Mike B. ``If the persistentIdentity of a compliant object must end with a delim + its displayId, then a compliant object's displayId may never change. If that was your intent, I think you should state it explicitly here, to reinforce an impliciation which otherwise might go unnoticed by readers.'' ANSWER: this is correct.  I've added a bullet below stating this. -CJM}
