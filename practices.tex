...
The \sbolmult{roles:A}{roles} property is REQUIRED and MUST contain a set of \sbol{URI}s that refers to particular term(s) describing the usage of the agent.
...
The \sbolmult{roles:U}{roles} property is REQUIRED and MAY contain a set of \sbol{URI}s that refer to particular term(s) describing the usage of an \sbol{entity} referenced by the \sbol{entity} property.
