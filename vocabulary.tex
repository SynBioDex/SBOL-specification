...
Describes the \sbol{Location} of a notable sub-sequence found within a \newline
\sbol{ComponentDefinition}'s \sbol{Sequence}. Optionally contains a child \sbol{Component} link.
...
In this case, a referencing \sbol{ComponentInstance} needs to be created in the design and a \sbol{MapsTo} is added to the instance for the sub-design, which associates the original and the referencing instance.
