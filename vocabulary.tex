...
\begin{itemize}
 ...
 \item A \sbol{TopLevel} URL MUST use the following pattern:
  ...
  \item A \sbol{TopLevel} object's URL MUST NOT be included as prefix for other \sbol{TopLevel} objects. 
