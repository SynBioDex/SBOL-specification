...
Describes the relative spatial position and orientation of two \sbol{ComponentInstance} objects that are contained within the same \sbol{Component}.
\end{itemize}
...
When a design \sbol{Component} includes another design as a sub-design, the parent design might need to refer to a \sbol{ComponentInstance} in the sub-design.
...
Describes the role that a \sbol{ComponentInstance} plays in an \sbol{Interaction}.
