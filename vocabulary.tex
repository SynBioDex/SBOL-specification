...
Links an SBOL representation of biological components and their interactions to computatinal models, such as quantitative or qualitative,  that may be used to predict the functional behavior of a biological design.
...
\Rtodo{Goksel: Needs a review, I updated the model description}
