...
\Rtodo{Add a standard toggle switch diagram of two things repressing each other and a simple explanation for people who do not already know the toggle switch.}
