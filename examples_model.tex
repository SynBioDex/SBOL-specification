...
\Ctodo{I would suggest a more complete and more explicit mapping of vocabulary to the toggle switch example. -bder}
...
\Dtodo{ComponentDefinition.types in the following figure are not consistent with the list of BioPax ontological terms described previously in the Data Model section}
