...
A \sbol{SubComponent} MAY have any number of \sbolmult{hasLocation:SC}{hasLocation} properties, each of type \sbol{URI} that MUST refer to \sbol{Location} objects that indicate the location of the \sbol{sequence} from the \sbol{instanceOf} \sbol{Component} in a \sbol{sequence} of the parent \sbol{Component}.
