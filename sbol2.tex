...
% BBF RFC \rfcnum{}:
\title{Synthetic Biology Open Language \texorpdfstring{\\[3pt]}{}\mbox{(SBOL) Version~2.1.0}}
...
Raik Grunberg & \emph{King Abdullah University for Science and Technology (KAUST), SA}\\
...
Zhen Zhang & \emph{University of South Florida, USA}\\
Chris Myers, Michael Zhang, Meher Samineni, Zach Zundel& \emph{University of Utah, USA}\\
Bryan Bartley, John H. Gennari, Herbert Sauro & \emph{University of Washington, USA}\\
\end{tabular}\\
\\
{\bf Non-author, by institution:}\\
\begin{tabular}{l>{\hspace*{15pt}}r}
