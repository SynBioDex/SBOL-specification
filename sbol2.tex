...
\end{tabular}\\
\Rtodo{I propose organizing authorship thus.  Is it OK? -JSB Yea, I really like the idea of listing editors and Chair first, and then others later. -- jhg}\\
\Ctodo{Fill in all rest of authors here.}
}
