...
\packageVersion{Version 2.2.0}
\packageVersionDate{October 31, 2017}

\title{BBF RFC \rfcnum{}: Synthetic Biology Open Language \texorpdfstring{\\[3pt]}{}\mbox{(SBOL) Version~2.2.0}}
