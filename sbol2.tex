...
% Resolved todos awaiting review:
...
\Rtodo{When editing, change the todos that you handle to \Rtodo, rather than just deleting them, so that a second person can review}

\Ctodo{Final pass before release must include:

Ensure that all references are defined
