...
\vspace{3mm}
\threezeroone{\includegraphics{example_serialization/example_rdfxml.pdf}}

Alternatively, the same example can be serialized in Turtle as follows:

\vspace{3mm}
\threezeroone{\includegraphics{example_serialization/example_turtle.pdf}}

\threezeroone{All SBOL libraries SHOULD support at least RDF/XML, N-Triples, JSON-LD, and Turtle.
