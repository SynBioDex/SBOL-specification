...
For example, the serialization of a \sbol{Component} embeds the serializations of the \sbol{SequenceConstraint} and \sbol{ComponentInstance} objects associated with it. Those \sbol{SequenceConstraint} objects, however, link to the \sbol{ComponentInstance} objects with a \sbol{URI} rather than embedding another copy.
