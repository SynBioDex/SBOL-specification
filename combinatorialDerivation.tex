...
\sbol{Constraint} objects that refer to their corresponding template \sbol{SubComponent}, and SHOULD have values of \sbolmult{role:F}{role} that contain the same values as the values \sbolmult{role:F}{role} in the template \sbol{SubComponent}.
