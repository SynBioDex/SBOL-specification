...
\twothreezero{
\printValid{The \sbolmult{measures:CI}{measures} property of a \sbol{ComponentInstance} is OPTIONAL and may contain a set of \sbol{Measure} objects.
...
\printValid{A \sbol{Component} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description},
 \sbol{annotations}, \sbol{access}, \sbolmult{definition:CI}{definition}, \sbolmult{mapsTos:CI}{mapsTos}, \sbolmult{roles:C}{roles}, \sbolmult{roleIntegration:C}{roleIntegration}, and \twothreezero{\sbol{sourceLocations}}.\\ Reference: \sec{sec:Component}}
...
\twothreezero{
\printValid{The \sbol{sourceLocations} property of a \sbol{Component} is OPTIONAL and MAY contain a set of \sbol{Location} objects.\\ Reference: \sec{sec:Component}}
}

\twothreezero{
\printModeling{The \sbol{Location} objects contained by the \sbol{sourceLocations} property of a single \sbol{Component} SHOULD NOT specify overlapping regions.\\ Reference: \sec{sec:Component}}
}

\twothreezero{
\printModeling{If the \sbol{sourceLocations} property of a \sbol{Component} refers to a set of \sbol{Range}s, and that \sbol{Component} is referenced by the \sbol{component} property of a \sbol{SequenceAnnotation} whose \sbol{locations} property also refers to a set of \sbol{Range}s, then the sum of lengths of the two sets of \sbol{Range}s MUST be equal.\\ Reference: \sec{sec:Component}}
}
...
\printValid{A \sbol{Range} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \twothreezero{\sbol{sequence},} \sbol{orientation}, \sbol{start}, and \sbol{end}.\\ Reference: \sec{sec:Range}}
...
\printValid{A \sbol{Module} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \\ \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{definition:M}{definition}, and \sbolmult{mapsTos:M}{mapsTos}.\\ Reference: \sec{sec:Module}}
...
\twothreezero{
\printValid{The \sbolmult{measures:M}{measures} property of a \sbol{Module} is OPTIONAL and may contain a set of \sbol{Measure} objects.
\\ Reference: \sec{sec:Module}}
}

\subsubsection*{Rules for the \class{FunctionalComponent} class} 
\setcounter{sbolCtr}{11801}

\printValid{A \sbol{FunctionalComponent} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{access}, \sbolmult{definition:M}{definition}, \sbolmult{mapsTos:M}{mapsTos}, and \sbol{direction}.\\ Reference: \sec{sec:ComponentInstance}}
...
\sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \\ \sbol{annotations}, \sbol{strategy}, \sbol{template}, and \sbol{variableComponents}.
...
\printValid{An \sbol{Attachment} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{source:A}{source}, \sbol{format}, \sbol{size}, and \sbol{hash}.\\ Reference: \sec{sec:Attachment}}
%A \sbol{Model} MUST inherit all properties of the \sbol{TopLevel} class.
...
\printValid{An \sbol{Experiment} MUST NOT have properties other than the following: \sbol{identity}, \sbol{displayId}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{attachments}, and \sbol{experimentalData}.\\ Reference: \sec{sec:Experiment}}
