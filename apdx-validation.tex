...
\twothreeone{
\printValid{The \sbolmult{measures:CI}{measures} property of a \sbol{Identified} is OPTIONAL and may contain a set of \sbol{Measure} objects.
\\ Reference: \sec{sec:Identified}}
}
...
\twothreeone{
\printValid{ \st{The measures property of a ComponentInstance is OPTIONAL and may contain a set of Measure objects.
...
\twothreeone{
\printValid{\st{The measures property of a Module is OPTIONAL and may contain a set of Measure objects.
\\ Reference: Module}}
}
...
\printValid{\st{The measures property of an Interaction is OPTIONAL and may contain a set of Measure objects.
...
\twothreeone{
\printValid{\st{The measures property of a Participation is OPTIONAL and may contain a set of Measure objects.
