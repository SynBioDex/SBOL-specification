...
\printValid{The \sbol{experimentalData} property of an \sbol{ExperimentalData} is REQUIRED and MUST contain one or more \sbol{URI}s.\\ Reference: \sec{sec:Experiment}}
