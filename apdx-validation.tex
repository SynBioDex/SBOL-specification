...
\twotwoone{
\printComplete{Provenance history formed by \sbol{wasGeneratedBy} properties of \sbol{Identified} objects and \sbol{entity} references in \sbol{Usage} objects MUST NOT form circular reference chains.
