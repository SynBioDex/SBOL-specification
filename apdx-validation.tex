...
are RECOMMENDED to be true of an SBOL Version~2.0 document.  
...
\twozeroone{\printValid{(removed)}
%An SBOL document MUST declare the use of the following XML namespace: \\ \textls[-25]{\uri{http://www.w3.org/1999/02/22-rdf-syntax-ns\#}}.\\
%Reference: \sec{xml-namespace}}

\printValid{(removed)}
%If an SBOL document includes any \sbol{name} or \sbol{description} properties, then it MUST declare the use of the following XML namespace: \\ \textls[-25]{\uri{http://purl.org/dc/terms/}}.\\ 
%Reference: \sec{xml-namespace}}

\printValid{(removed)}
%If an SBOL document includes any \sbol{wasDerivedFrom} properties, then it MUST declare the use of the following XML namespace: \\ \textls[-25]{\uri{http://www.w3.org/ns/prov\#}}.\\ Reference: \sec{xml-namespace}}

\printValid{An SBOL document MUST be serialized as a well-formed RDF/XML file.}}
...
\twozeroone{
\printModeling{(removed)}
% The \sbol{displayId} property of an \sbol{Identified} object SHOULD be locally unique. \\ 
%Reference: \sec{sec:Identified}}
}
...
\twozeroone{
\printModeling{If the \sbol{wasDerivedFrom} property of one \sbol{Identified} object refers to another \sbol{Identified} object with the same \sbol{persistentIdentity} property, then \sbol{version} property of the second \sbol{Identified} object SHOULD precede that of the first if both objects have a \sbol{version} that follows the conventions of semantic versioning.\\ Reference: \sec{sec:Identified}}
}
...
\printValid{The \sbol{wasDerivedFrom} property of an \sbol{Identified} object MUST NOT contain a \sbol{URI} reference to the \sbol{Identified} object itself.  \\ Reference: \sec{sec:Identified}}

\twozeroone{
\printComplete{\sbol{Identified} objects MUST NOT form circular reference chains via their \sbol{wasDerivedFrom} properties.\\ Reference: \sec{sec:Identified}}
}
...
\twozeroone{
\printValid{(removed)}
% A \sbol{TopLevel} object MUST inherit all properties of the \sbol{Identified} class.\\ Reference: \sec{sec:TopLevel}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{Sequence} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{elements}, and \sbol{encoding}.\\ Reference: \sec{sec:Sequence}}
...
\twozeroone{
\printModeling{
The \sbolmult{roles:CD}{roles} property of a \sbol{ComponentDefinition} SHOULD only contain a \sbol{URI} from the sequence feature branch of SO, if it includes the DNA or RNA type, as listed in Table 2, in its set of \sbolmult{types:CD}{types}.
...
\printValid{If multiple \sbol{MapsTo}s within the \sbol{Component}s of a \sbol{ComponentDefinition} refer to the same \sbol{Commponent} in the \sbol{local} field, then there MUST not be more than one \sbol{MapsTo} that has \sbol{refinement} with \sbol{URI} \url{http://sbols.org/v2\#useRemote}.\\ Reference: \sec{sec:ComponentDefinition}}

\printModeling{Exactly one \sbol{URI} contained by the \sbolmult{types:CD}{roles} property of a \sbol{ComponentDefinition} SHOULD refer to a term from the sequence feature branch of SO, if it includes the DNA type, as listed in \ref{tbl:componentdefinition_types}, in its set of \sbolmult{types:CD}{types}.\\ Reference: \sec{sec:ComponentDefinition}}
}
...
\twozeroone{
\printValid{(removed)}
%A \sbol{ComponentInstance} MUST inherit all properties of the \sbol{Identified} class.\\ Reference: \sec{sec:ComponentInstance}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{Component} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{access}, \sbolmult{definition:CI}{definition}, and \sbolmult{mapsTos:CI}{mapsTos}.\\ Reference: \sec{sec:ComponentInstance}}
...
\twozeroone{
\printValid{The only properties a \sbol{MapsTo} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{refinement}, \sbol{local}, and  \sbol{remote}\\ Reference: \sec{sec:MapsTo}}
...
\twozeroone{
\printWarning{(removed)}
% The \sbol{remote} property of a \sbol{MapsTo} MUST refer to a \sbol{ComponentInstance}.\\ Reference: \sec{sec:MapsTo}}
...
\twozeroone{
\printValid{The only properties a \sbol{SequenceAnnotation} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{component}, and \sbol{locations}.\\ Reference: \sec{sec:SequenceAnnotation}}
...
\twozeroone{
\printValid{(removed)}
%A \sbol{Location} MUST inherit all properties of the \sbol{Identified} class.\\ Reference: \sec{sec:Location}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{Range} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{orientation}, \sbol{start}, and \sbol{end}.\\ Reference: \sec{sec:Range}}
...
\twozeroone{
\printValid{The only properties a \sbol{Cut} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{orientation}, and \sbol{at}\\ Reference: \sec{sec:Cut}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{GenericLocation} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, and \sbol{orientation}.\\
Reference: \sec{sec:GenericLocation}}
...
\twozeroone{
\printValid{The only properties a \sbol{SequenceConstraint} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{restriction}, \sbol{subject}, and \sbol{object}.\\ Reference: \sec{sec:SequenceConstraint}}
...
\twozeroone{
\printValid{The only properties a \sbol{Model} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{source}, \sbol{language}, and \sbol{framework}.\\ Reference: \sec{sec:Model}}
...
\printValid{If multiple \sbol{MapsTo}s within the \sbol{modules} and \sbol{functionalComponents} of a \sbol{ModuleDefinition} refer to the same \sbol{FunctionalCommponent} in the \sbol{local} field, then there MUST not be more than one \sbol{MapsTo} that has \sbol{refinement} with \sbol{URI} \url{http://sbols.org/v2\#useRemote}.\\ Reference: \sec{sec:ModuleDefinition}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{Module} have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{definition:M}{definition}, and \sbolmult{mapsTos:M}{mapsTos}.\\ Reference: \sec{sec:Module}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{FunctionalComponent} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, and \sbol{access}.\\ Reference: \sec{sec:ComponentInstance}}
...
\twozeroone{
\printValid{The only properties a \sbol{Interaction} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{types:I}{types}, and \sbol{participations}.\\ Reference: \sec{sec:Interaction}}
...
\twozeroone{
\printValid{The only properties a \sbol{Participation} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{roles:P}{roles}, and \sbol{participant}\\ Reference: \sec{sec:Participation}}
...
\twozeroone{
\printValid{The \sbolmult{roles:P}{roles} property of a \sbol{Participation} is REQURIED and MUST contain a non-empty set of \sbol{URI}s.\\ Reference: \sec{sec:Participation}}
}
...
\twozeroone{
\printValid{The only properties a \sbol{Collection} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, and \sbol{members}.\\Reference: \sec{sec:Collection}}
}
...
\twozeroone{
\printValid{(removed)}
%The \sbol{name} property of an \sbol{Annotation} is REQUIRED and MUST contain a \sbol{QName}.\\ Reference: \sec{sec:Annotations}}

\printValid{(removed)}
%The \sbol{value} property of an \sbol{Annotation} is REQUIRED and MUST contain an \sbol{AnnotationValue}.\\ Reference: \sec{sec:Annotations}}
...
\twozeroone{
\printValid{The only properties a \sbol{GenericTopLevel} may have are: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, and \sbol{annotations}.\\Reference: \sec{sec:Collection}}
}
