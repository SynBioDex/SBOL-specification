...
\twotwozero{
\printComplete{\sbol{TopLevel} objects MUST NOT form circular reference chains via their \sbol{wasGeneratedBy} properties.\\ Reference: \sec{sec:wasGeneratedBys}}
}
...
\printWarning{A \sbol{Usage} with \sbol{roles} of \sbol{sbol:design} SHOULD refer to a ModuleDefinition, ComponentDefinition, or Sequence.\\ Reference: \sec{sec:Usage}}

\printWarning{A \sbol{Usage} with \sbol{roles} of \sbol{sbol:build} SHOULD refer to an Implementation.\\ Reference: \sec{sec:Usage}}

\printWarning{A \sbol{Usage} with \sbol{roles} of \sbol{sbol:test} refer to an \sbol{Attachment} or \sbol{Collection} of \sbol{Attachments} which refer to files containing raw, experimental data.\\ Reference: \sec{sec:Usage}}

\printWarning{A \sbol{Usage} with \sbol{roles} of \sbol{sbol:learn} SHOULD refer to a Model derived from fitting experimental data, a consensus \sbol{Sequence} derived from sequence analysis of a construct, or \sbol{Attachments} that reference files containing analyzed data (including graphs and tables).\\ Reference: \sec{sec:Usage}}
...
\printValid{An \sbol{Implementation} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, and \sbol{built}.\\ Reference: \sec{sec:implementation}}
