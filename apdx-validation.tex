...
\printValid{The \sbol{sequence} property of a \sbol{Location} is OPTIONAL. If present, it MUST contain the URI of a \sbol{Sequence} referenced by the \sbol{ComponentDefinition} containing the \sbol{Location}.}
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{sequence}, \sbol{orientation}, \sbol{start}, and \sbol{end}.\\ Reference: \sec{sec:Range}}
% A \sbol{Range} MUST inherit all properties of the \sbol{Location} class.
}

\printValid{If the \sbol{sequence} property of a \sbol{Range} is specified, it MUST be the URI of a \sbol{Sequence} object referenced by the containing \sbol{ComponentDefinition}.}
...
\printValid{If the \sbol{sequence} property of a \sbol{Cut} is specified, it MUST be the URI of a \sbol{Sequence} object referenced by the containing \sbol{ComponentDefinition}.}
...
\sbol{identity},\\
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{sequence}, and \sbol{orientation}.\\
Reference: \sec{sec:GenericLocation}}
%A \sbol{GenericLocation} MUST inherit all properties of the \sbol{Location} class.
}

\printValid{If the \sbol{sequence} property of a \sbol{GenericLocation} is specified, it MUST be the URI of a \sbol{Sequence} object referenced by the containing \sbol{ComponentDefinition}.}
