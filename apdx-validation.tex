...
\printValid{The \sbol{hasUnit} property of a \sbol{Measure} is REQUIRED and MUST contain a URI.\\ Reference: \sec{sec:Measure}}

\printValid{The \sbolmult{types:Measure}{types} property of a \sbol{Measure} is OPTIONAL and MAY contain a set of URIs.\\ Reference: \sec{sec:Measure}}

\printModeling{If the \sbolmult{types:Measure}{types} property of a \sbol{Measure} is non-empty, then exactly one of the URIs that this property contains SHOULD refer to a term from the systems description parameter branch of the SBO.\\ Reference: \sec{sec:Measure}}
