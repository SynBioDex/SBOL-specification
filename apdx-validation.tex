...
\printValid{The \sbol{subject} property REQUIRED and MUST contain a \sbol{URI} reference to a \sbol{Component}. (Reference: \sec{sec:SequenceConstraint})}
...
\printValid{The \sbol{object} property REQUIRED and MUST contain a \sbol{URI} reference to a \sbol{Component}. (Reference: \sec{sec:SequenceConstraint})}
