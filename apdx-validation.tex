...
\printModeling{Each \sbol{Sequence} object in the list of \sbol{sequences} SHOULD reference a \sbol{Sequence} object. (Reference: \sec{sec:ComponentDefinition})}
...
\printValid{The \sbol{sequences} property of a \sbol{ComponentDefinition} MUST NOT refer to more than one \sbol{Sequence} with the same \sbol{encoding}. (Reference: \sec{sec:ComponentDefinition})}
