...
\printValid{An \sbol{Activity} MUST NOT have properties other than the following: \sbol{identity},\\ \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\ \sbol{description}, \sbol{annotations}, \sbol{startedAtTime}, \sbol{endedAtTime}, \sbol{wasInformedBys},\\ \sbol{qualifiedUsages}, and \sbol{qualifiedAssociations}.\\ Reference: \sec{sec:provenance}}
...
\printValid{The \sbol{qualifiedAssociations} property of an \sbol{Activity} is OPTIONAL and MAY contain a set of \sbol{Association} objects.\\ Reference: \sec{sec:provenance}}

\printValid{The \sbol{qualifiedUsages} property of an \sbol{Activity} is OPTIONAL and MAY contain a set of \sbol{Usage} objects.\\ Reference: \sec{sec:provenance}}
...
\printValid{An \sbol{Usage} MUST NOT have properties other than the following: \sbol{identity},\\ \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\ \sbol{description}, \sbol{annotations},  \sbol{entity}, and \sbol{hadRole}.\\ Reference: \sec{sec:provenance}}
...
\printValid{The \sbol{hadRole} property of an \sbol{Usage} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:provenance}}

\subsubsection*{Rules for the \class{Association} class} 
\setcounter{sbolCtr}{12601}

\printValid{An \sbol{Association} MUST NOT have properties other than the following: \sbol{identity},\\ \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\ \sbol{description}, \sbol{annotations},  \sbol{hadRole}, \sbol{hadPlan}, and \sbol{agent}.\\ Reference: \sec{sec:provenance}}

\printValid{The \sbol{hadRole} property of an \sbol{Association} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:provenance}}

\printValid{The \sbol{hadPlan} property of an \sbol{Association} is OPTIONAL and MAY contain a \sbol{URI}.\\ Reference: \sec{sec:provenance}}

\printComplete{The \sbol{URI} contained by the \sbol{hadPlan} property MUST refer to a \sbol{Plan} object.\\ Reference: \sec{sec:provenance}}
