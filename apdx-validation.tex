...
\twozeroone{
\printValid{A \sbol{SequenceAnnotation} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{component}, and \sbol{locations}.\\ Reference: \sec{sec:SequenceAnnotation}}
...
\twozeroone{
\printValid{A \sbol{FunctionalComponent} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations},\sbol{access}, \sbol{definition}, \sbol{mapsTo}, and \sbol{direction}.\\ Reference: \sec{sec:ComponentInstance}}
