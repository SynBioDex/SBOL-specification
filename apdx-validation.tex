...
\printValid{The \sbol{source} property is a REQUIRED URI that specifies the location of the model source file.}
...
\printWarning{The \sbol{source} property MUST specify the location of the model source file in the specified \sbol{language} using the specified \sbol{framework}.}
...
\printValid{The \sbol{ComponentInstance} referenced by the \sbol{local} property MUST have \sbol{public} access type.}

\printValid{The \sbol{ComponentInstance} referenced by the \sbol{remote} property MUST have \sbol{public} access type.}
