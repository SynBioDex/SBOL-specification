...
\twozeroone{
\printValid{A \sbol{ComponentInstance} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{types:CD}{types}, \sbolmult{roles:CD}{roles}, \sbol{components}, \sbol{sequences}, \\ \sbol{sequenceAnnotations}, and \sbol{sequenceConstraints}.\\ 
Reference: \sec{sec:SubComponent}}
%A \sbol{ComponentInstance} MUST inherit all properties of the \sbol{TopLevel} class.}
}

\printValid{The \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} is REQUIRED and MUST contain a non-empty set of \sbol{URI}s.\\ Reference: \sec{sec:Component}}

\printValid{The \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} MUST NOT contain more than one \sbol{URI} from \ref{tbl:component_types}.\\ Reference: \sec{sec:Component}}

\printWarning{Each \sbol{URI} contained by the \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} MUST refer to an ontology term that describes the category of biochemical or physical entity that is represented by the \sbol{ComponentInstance}.\\ Reference: \sec{sec:Component}}

\printWarning{The \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} MUST contain a \sbol{URI} from \ref{tbl:component_types} if it is well-described by this \sbol{URI}.\\ Reference: \sec{sec:Component}}

\printWarning{All \sbol{URI}s contained by the \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} MUST refer to non-conflicting ontology terms.\\ Reference: \sec{sec:Component}}

\printValid{The \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{URI}s.\\ Reference: \sec{sec:Component}}

\printWarning{Each \sbol{URI} contained by the \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} MUST refer to an ontology term that clarifies the potential function of the \sbol{ComponentInstance} in a biochemical or physical context.\\ Reference: \sec{sec:Component}}

\printWarning{Each \sbol{URI} contained by the \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} MUST refer to an ontology term that is consistent with its \sbolmult{types:CD}{types} property.\\ Reference: \sec{sec:Component}}

\printWarning{The \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} MUST contain a \sbol{URI} from \ref{tbl:component_roles} if it is well-described by this \sbol{URI}.\\ Reference: \sec{sec:Component}}

\twozeroone{
\printModeling{
The \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} SHOULD NOT contain a \sbol{URI} that refers to a term from the sequence feature branch of the SO unless its \sbolmult{types:CD}{types} property contains the DNA or RNA type \sbol{URI} listed in \ref{tbl:component_types}.
%The \sbolmult{roles:CD}{roles} property of a  \sbol{ComponentInstance} SHOULD only contain a \sbol{URI} provided in  \ref{tbl:component_roles} if one of its \sbolmult{types:CD}{types} is cross-listed with this \sbol{URI}.
\\ Reference: \sec{sec:Component}}
%\\ Reference: \sec{sec:recomm_ontologies}}
}

\printValid{The \sbol{sequences} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{URI}s.\\ Reference: \sec{sec:Component}}

\twozeroone{
\printComplete{Each \sbol{URI} contained by the \sbol{sequences} property of a \sbol{ComponentInstance} MUST refer to a \sbol{Sequence} object.\\ Reference: \sec{sec:Component}}
}

\printWarning{The \sbol{Sequence} objects referred to by the \sbol{sequences} property of a \sbol{ComponentInstance} MUST be consistent with each other, such that well-defined mappings exist between their \sbol{elements} properties in accordance with their \sbol{encoding} properties.\\ Reference: \sec{sec:Component}}

\printWarning{The \sbol{sequences} property of a \sbol{ComponentInstance} MUST NOT refer to \sbol{Sequence} objects with conflicting \sbol{encoding} properties.\\ Reference: \sec{sec:Component}}

% Redundant since subsumed by previous rule of equivalent strength
% \printWarning{The \sbol{sequences} property of a \sbol{ComponentInstance} MUST NOT refer to \sbol{Sequence} objects with conflicting \external{IUPAC} \sbol{encoding} \external{URI}s from \ref{tbl:sequence_encodings}.\\ Reference: \sec{sec:Component}}

\twozeroone{
\printComplete{If the \sbol{sequences} property of a \sbol{ComponentInstance} refers to one or more \sbol{Sequence} objects, and one of the  \sbolmult{types:CD}{types} of this \sbol{ComponentInstance} comes from \ref{tbl:component_types}, then one of the \sbol{Sequence} objects MUST have the \sbol{encoding} that is cross-listed with this type in \ref{tbl:sequence_encodings}.\\ 
Reference: \sec{sec:Component}}
...
\printModeling{If a \sbol{ComponentInstance} refers to more than one \sbol{Sequence} with the same \sbol{encoding}, then the \sbol{elements} of these \sbol{Sequence} objects SHOULD have equal lengths.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{components} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{ComponentInstance} objects.\\ Reference: \sec{sec:Component}}

\printModeling{If a \sbol{ComponentInstance} in a \sbol{ComponentInstance}-\sbol{ComponentInstance} hierarchy refers to one or more \sbol{Sequence} objects, and there exist \sbol{ComponentInstance} objects lower in the hierarchy that refer to \sbol{Sequence} objects with the same \sbol{encoding}, then the \sbol{elements} properties of these \sbol{Sequence} objects SHOULD be consistent with each other, such that well-defined mappings exist from the ``lower level'' \sbol{elements} to the ``higher level'' \sbol{elements} in accordance with their shared \sbol{encoding} properties. This mapping is also subject to any restrictions on the positions of the \sbol{ComponentInstance} objects in the hierarchy that are imposed by the \sbol{SequenceAnnotation} or \sbol{SequenceConstraint} objects contained by the \sbol{ComponentInstance} objects in the hierarchy.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{sequenceAnnotations} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{SequenceAnnotation} objects.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{sequenceAnnotations} property of a \sbol{ComponentInstance} MUST NOT contain two or more \sbol{SequenceAnnotation} objects that refer to the same \sbol{ComponentInstance}.\\ Reference: \sec{sec:Component}}

\printModeling{If the \sbol{sequences} property of a \sbol{ComponentInstance} refers to a \sbol{Sequence} with an \external{IUPAC} \sbol{encoding} from \ref{tbl:sequence_encodings}, then each \sbol{SequenceAnnotation} that includes a \sbol{Range} and/or \sbol{Cut} in the \sbol{sequenceAnnotations} property of the \sbol{ComponentInstance} SHOULD specify a region on the \sbol{elements} of this \sbol{Sequence}.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{sequenceConstraints} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{SequenceConstraint} objects.  \\ Reference: \sec{sec:Component}}

\twozeroone{
\printModeling{The \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} SHOULD contain a \sbol{URI} from \ref{tbl:component_types}.\\ Reference: \sec{sec:Component}}

\printValid{If multiple \sbol{MapsTo}s belonging to the \sbol{ComponentInstance}s of a \sbol{ComponentInstance} have \sbol{local} properties that refer to the same \sbol{ComponentInstance}, then there MUST NOT be more than one such \sbol{MapsTo} that has a \sbol{refinement} property that contains the \sbol{URI}~\url{http://sbols.org/v2\#useRemote}.\\ Reference: \sec{sec:MapsTo}}

% \printModeling{Exactly one \sbol{URI} contained by the \sbolmult{roles:CD}{roles} property of a \sbol{ComponentInstance} SHOULD refer to a term from the sequence feature branch of SO, if it includes the DNA or RNA type, as listed in \ref{tbl:component_types}, in its set of \sbolmult{types:CD}{types}.\\ 
% Reference: \sec{sec:Component}}}

\printModeling{If the \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} contains the DNA or RNA type \sbol{URI}, then its \sbolmult{types:CD}{roles} property SHOULD contain exactly one \sbol{URI} that refers to a term from the sequence feature branch of the SO.\\ 
Reference: \sec{sec:Component}}
}

\twoonezero{
\printModeling{If the \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} contains the DNA or RNA type \sbol{URI}, then its \sbolmult{types:CD}{types} property SHOULD also contain at most one \sbol{URI} that refers to a term from the topology attribute branch of the SO.\\ 
Reference: \sec{sec:Component}}
}

%\printModeling{If the \sbolmult{types:CD}{types} property of
%a \sbol{ComponentInstance} contains the DNA type \sbol{URI}, then it SHOULD
...
\twoonezero{
\printModeling{
The \sbolmult{roles:CD}{types} property of a \sbol{ComponentInstance} SHOULD NOT contain a \sbol{URI} that refers to a term from the topology attribute or strand attribute branches of the SO unless its \sbolmult{types:CD}{types} property contains the DNA or RNA type \sbol{URI} listed in \ref{tbl:component_types}.
Reference: \sec{sec:Component}}
}

\twoonezero{
\printWarning{If the \sbolmult{types:CD}{types} property of a \sbol{ComponentInstance} contains the DNA or RNA type \sbol{URI}, then its \sbolmult{types:CD}{types} property MUST contain a \sbol{URI} that refers to a term from the topology attribute branch of the SO, if the topology is known.\\ Reference: \sec{sec:Component}}
}

%\twoonezero{
%\printValid{If the \sbolmult{types:CD}{types} property of
%a \sbol{ComponentInstance} is pointing to anything other than DNA or RNA
...
\printValid{The \sbolmult{instanceOf:CI}{instanceOf} property of a \sbol{ComponentInstance} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:ComponentInstance}}

\printValid{The \sbolmult{instanceOf:CI}{instanceOf} property of a \sbol{ComponentInstance} MUST NOT contain a \sbol{URI} reference to the \sbol{ComponentInstance} that contains the \sbol{ComponentInstance}.\\ Reference: \sec{sec:ComponentInstance}}

\twozeroone{
\printComplete{The \sbol{URI} contained by the \sbolmult{instanceOf:CI}{instanceOf} property MUST refer to a \sbol{ComponentInstance} object.\\ Reference: \sec{sec:ComponentInstance}}

\printComplete{\sbol{ComponentInstance} objects MUST NOT form circular reference chains via their \sbolmult{instanceOf:CI}{instanceOf} properties and parent \sbol{ComponentInstance} objects.\\ Reference: \sec{sec:ComponentInstance}}
}
...
\twoonezero{
\printValid{A \sbol{ComponentInstance} MUST NOT have properties other than the following: \sbol{identity},\\ \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description},
...
% A \sbol{ComponentInstance} MUST inherit all properties of the \sbol{ComponentInstance} class.
}

\twoonezero{
\printValid{The \sbolmult{roles:C}{roles} property of a \sbol{ComponentInstance} is OPTIONAL and MAY contain a set of \sbol{URI}s.\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printWarning{Each \sbol{URI} contained by the \sbolmult{roles:C}{roles} property of a \sbol{ComponentInstance} MUST refer to an ontology term that clarifies the potential function of the \sbol{ComponentInstance} in a biochemical or physical context.\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printWarning{Each \sbol{URI} contained by the \sbolmult{roles:C}{roles} property of a \sbol{ComponentInstance} MUST refer to an ontology term that is consistent with the  \sbolmult{types:CD}{types} property of the \sbol{ComponentInstance} referred to by its \sbolmult{instanceOf:CI}{instanceOf} property.\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printWarning{The \sbolmult{roles:C}{roles} property of a \sbol{ComponentInstance} MUST contain a \sbol{URI} from \ref{tbl:component_roles} if it is well-described by this \sbol{URI}.\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printModeling{
The \sbolmult{roles:C}{roles} property of a \sbol{ComponentInstance} SHOULD NOT contain a \sbol{URI} that refers to a term from the sequence feature branch of the SO unless the  \sbolmult{types:CD}{types} property of the \sbol{ComponentInstance} referred to by its \sbolmult{instanceOf:CI}{instanceOf} property contains the DNA or RNA type \sbol{URI} listed in \ref{tbl:component_types}.
\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printModeling{If the \sbolmult{types:CD}{types} property of the \sbol{ComponentInstance} referred to by its \sbolmult{instanceOf:CI}{instanceOf} contains the DNA or RNA type \sbol{URI}, then its \sbolmult{roles:C}{roles} property SHOULD contain no more than one \sbol{URI} that refers to a term from the sequence feature branch of the SO.\\ 
Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printValid{The \sbolmult{roleIntegration:C}{roleIntegration} property of a \sbol{ComponentInstance}, if provided, MUST contain a \sbol{URI} from \ref{tbl:component_roleIntegration}.
\\ Reference: \sec{sec:SubComponent}}
}

\twoonezero{
\printValid{The \sbolmult{roleIntegration:C}{roleIntegration} property of a \sbol{ComponentInstance} is REQUIRED, if \sbolmult{roles:C}{roles} property includes one or more roles.
\\ Reference: \sec{sec:SubComponent}}
}
...
\printValid{If a \sbol{MapsTo} is contained by a \sbol{ComponentInstance} in a \sbol{ComponentInstance}, then the \sbol{local} property of the \sbol{MapsTo} MUST refer to another \sbol{ComponentInstance} in the \sbol{ComponentInstance}.\\ Reference: \sec{sec:MapsTo}}

\printValid{If a \sbol{MapsTo} is contained by a \sbol{ComponentInstance} or \sbol{ComponentInstance} in a \sbol{ComponentInstance}, then the \sbol{local} property of the \sbol{MapsTo} MUST refer to another \sbol{ComponentInstance} in the \sbol{ComponentInstance}.\\ Reference: \sec{sec:MapsTo}}
...
\printComplete{If a \sbol{MapsTo} is contained by a \sbol{ComponentInstance}, then the \sbol{remote} property of the \sbol{MapsTo} MUST refer to a \sbol{ComponentInstance} in the \sbol{ComponentInstance} that is referenced by the\\
\sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{ComponentInstance}.\\ Reference: \sec{sec:MapsTo}} 

\printComplete{If a \sbol{MapsTo} is contained by a \sbol{ComponentInstance}, then the \sbol{remote} property of the \sbol{MapsTo} MUST refer to a \sbol{ComponentInstance} in the \sbol{ComponentInstance} that is referenced by the \sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{ComponentInstance}.\\ Reference: \sec{sec:MapsTo}} 
}
...
\twozeroone{
\printComplete{If the \sbol{refinement} property of a \sbol{MapsTo} contains the \sbol{URI}\\ \url{http://sbols.org/v2\#verifyIdentical}, then the \sbol{ComponentInstance} objects referred to by \sbol{local} and \sbol{remote} properties of the \sbol{MapsTo} MUST refer to the same \sbol{ComponentInstance} via their \sbolmult{instanceOf:CI}{instanceOf} properties.\\ Reference: \sec{sec:MapsTo}}
}
...
\printValid{The \sbol{component} property is OPTIONAL and MAY contain a \sbol{URI} reference to a \sbol{ComponentInstance}.\\ Reference: \sec{sec:SequenceAnnotation}}

\printValid{The \sbol{ComponentInstance} referenced by the \sbol{component} property of a \sbol{SequenceAnnotation} MUST be contained by the \sbol{ComponentInstance} that contains the \sbol{SequenceAnnotation}.\\ Reference: \sec{sec:SequenceAnnotation}}
...
\twothreezero{
\printComplete{The \sbol{sequence} property of a \sbol{Location} is OPTIONAL. If present, it MUST contain the URI of a \sbol{Sequence} referenced by the \sbol{ComponentInstance} containing the \sbol{Location}.\\
...
\twothreezero{
\printComplete{The \sbol{sequence} property of a \sbol{Range} is OPTIONAL. If present, it MUST contain the URI of a \sbol{Sequence} referenced by the \sbol{ComponentInstance} containing the \sbol{Range}.\\
Reference: \sec{sec:sequence}
}
}
...
\twothreezero{
\printComplete{The \sbol{sequence} property of a \sbol{Cut} is OPTIONAL. If present, it MUST contain the URI of a \sbol{Sequence} referenced by the \sbol{ComponentInstance} containing the \sbol{Cut}.\\
Reference: \sec{sec:sequence}
}
}
...
\twothreezero{
\printComplete{The \sbol{sequence} property of a \sbol{GenericLocation} is OPTIONAL. If present, it MUST contain the URI of a \sbol{Sequence} referenced by the \sbol{ComponentInstance} containing the \sbol{GenericLocation}.\\
Reference: \sec{sec:sequence}
}
}
...
\printValid{The \sbol{subject} property of a \sbol{SequenceConstraint} is REQUIRED and MUST contain a \sbol{URI} reference to a \sbol{ComponentInstance}.\\ Reference: \sec{sec:SequenceConstraint}}

\printValid{The \sbol{ComponentInstance} referenced by the \sbol{subject} property of a \sbol{SequenceConstraint} MUST be contained by the \sbol{ComponentInstance} that contains the \sbol{SequenceConstraint}.\\ Reference: \sec{sec:SequenceConstraint}}

\printValid{The \sbol{object} property of a \sbol{SequenceConstraint} is REQUIRED and MUST contain a \sbol{URI} reference to a \sbol{ComponentInstance}.\\ Reference: \sec{sec:SequenceConstraint}}

\printValid{The \sbol{ComponentInstance} referenced by the \sbol{object} property of a \sbol{SequenceConstraint} MUST be contained by the \sbol{ComponentInstance} that contains the \sbol{SequenceConstraint}.\\ Reference: \sec{sec:SequenceConstraint}}

\printValid{The \sbol{object} property of a \sbol{SequenceConstraint} MUST NOT refer to the same \sbol{ComponentInstance} as the \sbol{subject} property of the \sbol{SequenceConstraint}.\\ Reference: \sec{sec:SequenceConstraint}}
...
\printWarning{The \sbol{URI} contained by the \sbol{restriction} property of a \sbol{SequenceConstraint} MUST indicate the type of structural restriction on the relative, sequence-based positions or orientations of the \sbol{ComponentInstance} objects referred to by the \sbol{subject} and \sbol{object} properties of the \sbol{SequenceConstraint}.
\\ Reference: \sec{sec:SequenceConstraint}}

\twozeroone{
\printComplete{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI}~\url{http://sbols.org/v2\#precedes}, then the position of the \sbol{ComponentInstance} referred to by the \sbol{subject} property of the \sbol{SequenceConstraint} MUST precede that of the \sbol{ComponentInstance} referred to by its \sbol{object} property.
\\ Reference: \sec{sec:SequenceConstraint}}

\printComplete{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI}~\url{http://sbols.org/v2\#sameOrientationAs}, then the orientation of the \sbol{ComponentInstance} referred to by the \sbol{subject} property of the \sbol{SequenceConstraint} MUST be the same as that of the \sbol{ComponentInstance} referred to by its \sbol{object} property.
\\ Reference: \sec{sec:SequenceConstraint}}

\printComplete{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI}~\url{http://sbols.org/v2\#oppositeOrientationAs}, then the orientation of the \sbol{ComponentInstance} referred to by the \sbol{subject} property of the \sbol{SequenceConstraint} MUST be opposite that of the \sbol{ComponentInstance} referred to by its \sbol{object} property.
\\ Reference: \sec{sec:SequenceConstraint}}
}
...
\twotwozero{
\printValid{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI}~\url{http://sbols.org/v2\#differentFrom}, then the \sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{subject} \sbol{ComponentInstance} of the \sbol{SequenceConstraint} MUST NOT refer to the the same \sbol{URI} as the \sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{object} \sbol{ComponentInstance} of the \sbol{SequenceConstraint}.
\\ Reference: \sec{sec:SequenceConstraint}}
}

\twotwoone{
\printComplete{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI}~\url{http://sbols.org/v2\#differentFrom}, then the \sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{subject} \sbol{ComponentInstance} of the \sbol{SequenceConstraint} MUST NOT refer to the same object as the \sbolmult{instanceOf:CI}{instanceOf} property of the \sbol{object} \sbol{ComponentInstance} of the \sbol{SequenceConstraint}.
\\ Reference: \sec{sec:SequenceConstraint}}
}
...
\printWarning{Each \sbol{URI} contained by \sbolmult{roles:MD}{roles} property of a \sbol{ComponentInstance} MUST refer to a resource that clarifies the intended function of the \sbol{ComponentInstance}.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{modules} property OPTIONAL and MAY contain a set of \sbol{ComponentInstance} objects.\\ Reference: \sec{sec:Component}}
...
\printValid{The \sbol{functionalComponents} property is OPTIONAL and MAY contain a set of\\ \sbol{ComponentInstance} objects.\\ Reference: \sec{sec:Component}}

\printValid{The \sbol{models} property is OPTIONAL and MAY contain a set of \sbol{URI}s.  \\ Reference: \sec{sec:Component}}

\twozeroone{
\printComplete{Each \sbol{URI} contained by the \sbol{models} property of a \sbol{ComponentInstance} MUST refer to a \sbol{Model}.\\ Reference: \sec{sec:Component}}

\printValid{If multiple \sbol{MapsTo}s belonging to the \sbol{ComponentInstance}s and \sbol{ComponentInstance}s of a \\
\sbol{ComponentInstance} have \sbol{local} properties that refer to the same \sbol{ComponentInstance}, then there MUST NOT be more than one such \sbol{MapsTo} that has a \sbol{refinement} property that contains the \sbol{URI}~\url{http://sbols.org/v2\#useRemote}.\\ Reference: \sec{sec:MapsTo}}}

\subsubsection*{Rules for the \class{ComponentInstance} class} 
\setcounter{sbolCtr}{11701}

\twozeroone{
\printValid{A \sbol{ComponentInstance} MUST NOT have properties other than the following: \sbol{identity}, \\
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbolmult{instanceOf:M}{instanceOf}, and \sbolmult{mapsTos:M}{mapsTos}.\\ Reference: \sec{sec:SubComponent}}
}

\printValid{The \sbolmult{instanceOf:M}{instanceOf} property of a \sbol{ComponentInstance} is REQUIRED and MUST contain a \sbol{URI}. \\ Reference: \sec{sec:SubComponent}}

\twozeroone{
\printComplete{The \sbol{URI} contained by the \sbolmult{instanceOf:M}{instanceOf} property of \sbol{ComponentInstance} MUST refer to a\\
\sbol{ComponentInstance}.\\ Reference: \sec{sec:SubComponent}}
}

\printValid{The \sbolmult{instanceOf:CI}{instanceOf} property of a \sbol{ComponentInstance} MUST NOT contain a \sbol{URI} reference to the\\ \sbol{ComponentInstance} that contains the \sbol{ComponentInstance}.\\ Reference: \sec{sec:SubComponent}}

\twozeroone{
\printComplete{\sbol{ComponentInstance} objects MUST NOT form circular reference chains via their \sbolmult{instanceOf:CI}{instanceOf} properties and parent \sbol{ComponentInstance} objects.\\ Reference: \sec{sec:SubComponent}}
}
...
\printValid{The \sbol{direction} property of a \sbol{ComponentInstance} is REQUIRED and MUST contain a \sbol{URI} from \ref{tbl:functionalcomponent_directions}.
\\ Reference: \sec{sec:SubComponent}}
...
\printValid{The \sbol{participant} property of a \sbol{Participation} is REQUIRED and MUST contain a \sbol{URI} reference to a \sbol{ComponentInstance}.\\ Reference: \sec{sec:Participation}}

\printValid{The \sbol{ComponentInstance} referenced by the \sbol{participant} property of a \sbol{Participation} MUST be contained by the \sbol{ComponentInstance} that contains the \sbol{Interaction} which contains the \sbol{Participation}.\\ Reference: \sec{sec:Participation}}
...
\printComplete{The URI contained by the \sbol{template} property of a \sbol{CombinatorialDerivation} MUST refer to a \sbol{ComponentInstance}.
\\ Reference: \sec{sec:CombinatorialDerivation}}
...
\printComplete{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\
\sbol{CombinatorialDerivation} and the template \sbol{ComponentInstance} of the\\
\sbol{CombinatorialDerivation} contains \sbol{SequenceConstraint} objects, then any \sbol{ComponentInstance}\\
contained by the first \sbol{ComponentInstance} that has a \sbol{wasDerivedFroms} property that refers to the \sbol{subject} or \sbol{object} \sbol{ComponentInstance} of any of the \sbol{SequenceConstraint} objects MUST adhere to the \sbol{restriction} properties of these \sbol{SequenceConstraint} objects.
\\ Reference: \sec{sec:CombinatorialDerivation}}

\printModeling{The \sbol{components} property of the template \sbol{ComponentInstance} of a\\
\sbol{CombinatorialDerivation} SHOULD contain one or more \sbol{ComponentInstance} objects.
\\ Reference: \sec{sec:CombinatorialDerivation}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\ \sbol{CombinatorialDerivation}, then the \sbolmult{types:CD}{types} property of this \sbol{ComponentInstance} \\
SHOULD contain all \sbol{URI}s contained by the \sbolmult{types:CD}{types} property of the template\\
\sbol{ComponentInstance} of the \sbol{CombinatorialDerivation}.
\\ Reference: \sec{sec:CombinatorialDerivation}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\ \sbol{CombinatorialDerivation}, then the \sbolmult{types:CD}{roles} property of this \sbol{ComponentInstance} \\
...
\printComplete{The \sbol{URI} contained by the \sbol{variable} property of a \sbol{VariableComponent} MUST refer to a \sbol{ComponentInstance} contained by the \sbol{components} property of the template \sbol{ComponentInstance} of the \sbol{CombinatorialDerivation} that contains the \sbol{VariableComponent}.
\\ Reference: \sec{sec:VariableComponent}}
}
...
\printComplete{The \sbol{URI}s contained by the \sbol{variants} property of a \sbol{VariableComponent} MUST refer to\\ \sbol{ComponentInstance} objects.
\\ Reference: \sec{sec:VariableComponent}}
...
\printComplete{The \sbol{members} property of a \sbol{Collection} that is referred to by the \sbol{variantCollections} property of a \sbol{VariableComponent} MUST refer only to \sbol{ComponentInstance} objects.
\\ Reference: \sec{sec:VariableComponent}}
...
\twotwoone{
\printComplete{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a \sbol{ComponentInstance} in the \sbol{template} \sbol{ComponentInstance} of a \sbol{CombinatorialDerivation}, and the second \sbol{ComponentInstance} is referred to by the \sbol{variable} property of any \sbol{VariableComponent} in the \\
\sbol{CombinatorialDerivation}, then the \sbolmult{instanceOf:CI}{instanceOf} property of the first \sbol{ComponentInstance} MUST refer to a \sbol{ComponentInstance} specified by the \sbol{variants} property,
a \sbol{ComponentInstance} that is one of the \sbol{members} of a \sbol{Collection} specified by the \sbol{variantCollections} property, or a \sbol{ComponentInstance} with a \sbol{wasDerivedFroms} property that refers to a\\
...
\twotwozero{
\printComplete{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a \sbol{ComponentInstance} in the \sbol{template} \sbol{ComponentInstance} of a \sbol{CombinatorialDerivation}, and the second \sbol{ComponentInstance} is not referred to by the \sbol{variable} property of any \sbol{VariableComponent} in the\\
\sbol{CombinatorialDerivation}, then the \sbolmult{instanceOf:CI}{instanceOf} property of the first \sbol{ComponentInstance} MUST refer to the same \sbol{ComponentInstance} as the \sbolmult{instanceOf:CI}{instanceOf} property of the second \sbol{ComponentInstance}.
\\ Reference: \sec{sec:VariableComponent}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\ \sbol{CombinatorialDerivation} and the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} contained by the \sbol{ComponentInstance} refers to a \sbol{ComponentInstance} contained by the template\\
\sbol{ComponentInstance} of the \sbol{CombinatorialDerivation}, then the \sbolmult{types:CD}{roles} property of the first \sbol{ComponentInstance} SHOULD contain all \sbol{URI}s contained by the \sbolmult{types:CD}{roles} property of the second \sbol{ComponentInstance}.
\\ Reference: \sec{sec:VariableComponent}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\ \sbol{CombinatorialDerivation} and the \sbol{CombinatorialDerivation} contains a\\
\sbol{VariableComponent} with an \sbol{operator} property that contains the \sbol{URI}~\url{http://sbols.org/v2\#zeroOrOne}, then the \sbol{components} property of the \sbol{ComponentInstance} SHOULD NOT contain more than one \sbol{ComponentInstance} with a \sbol{wasDerivedFroms} property that refers to the same \sbol{ComponentInstance} as the \sbol{variable} property of the \sbol{VariableComponent}.
\\ Reference: \sec{sec:VariableComponent}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\
\sbol{CombinatorialDerivation} and the \sbol{CombinatorialDerivation} contains a\\
\sbol{VariableComponent} with an \sbol{operator} property that contains the \sbol{URI}~\url{http://sbols.org/v2\#one}, then the \sbol{components} property of the \sbol{ComponentInstance} SHOULD contain exactly one \sbol{ComponentInstance} with a\\
\sbol{wasDerivedFroms} property that refers to the same\\
\sbol{ComponentInstance} as the \sbol{variable} property of the \sbol{VariableComponent}.
\\ Reference: \sec{sec:VariableComponent}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\
\sbol{CombinatorialDerivation} and the \sbol{CombinatorialDerivation} contains a\\
\sbol{VariableComponent} with an \sbol{operator} property that contains the \sbol{URI}~\url{http://sbols.org/v2\#oneOrMore}, then the \sbol{components} property of the \sbol{ComponentInstance} SHOULD contain at least one \sbol{ComponentInstance} with a\\
\sbol{wasDerivedFroms} property that refers to the same \sbol{ComponentInstance} as the \sbol{variable} property of the\\ \sbol{VariableComponent}.
\\ Reference: \sec{sec:VariableComponent}}

\printModeling{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentInstance} refers to a\\ \sbol{CombinatorialDerivation} and the template \sbol{ComponentInstance} of the\\ \sbol{CombinatorialDerivation} contains a \sbol{ComponentInstance} that is not referred to by the \sbol{variable} property of any \sbol{VariableComponent} contained by the \sbol{CombinatorialDerivation}, then the first \sbol{ComponentInstance} SHOULD contain exactly one \sbol{ComponentInstance} with a\\
\sbol{wasDerivedFroms} property that refers to the \sbol{ComponentInstance} in the template\\
...
\printComplete{The \sbol{built} property \sbol{URI}, if specified, MUST refer to either a \sbol{ComponentInstance} or a \sbol{ComponentInstance}.\\ Reference: \sec{sec:Implementation}}
} 
