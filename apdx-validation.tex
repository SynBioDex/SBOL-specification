...
\printValid{If a \sbol{Feature} has an \sbolmult{orientation:F}{orientation} property, its \sbol{URL} MUST be drawn from \ref{tbl:orientation_types}.\\ Reference: \sec{sec:Feature}}
...
\printValid{If a \sbol{Location} has an \sbolmult{orientation:L}{orientation} property, its \sbol{URL} MUST be drawn from \ref{tbl:orientation_types}.\\ Reference: \sec{sec:Location}}
