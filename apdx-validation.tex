...
\twotwozero{
\printValid{If the \sbol{restriction} property of a \sbol{SequenceConstraint} contains the \sbol{URI} \url{http://sbols.org/v2\#differentFrom}, then the \sbol{definition} property of the \sbol{subject} \sbol{Component} of the \sbol{SequenceConstraint} MUST NOT contain the same \sbol{URI} as the \sbol{definition} property of the \sbol{object} \sbol{Component} of the \sbol{SequenceConstraint}.
\\ Reference: \sec{sec:SequenceConstraint}}
}
...
\twozeroone{
\printValid{A \sbol{Model} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \twotwozero{\sbol{wasDerivedFroms}}, \twotwozero{\sbol{wasGeneratedBys}}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{source}, \sbol{language}, and \sbol{framework}.\\ Reference: \sec{sec:Model}}
%A \sbol{Model} MUST inherit all properties of the \sbol{TopLevel} class.
}

\printValid{The \sbol{source} property of a \sbol{Model} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:Model}}
...
\printValid{The \sbol{strategy} property of a \sbol{CombinatorialDerivation} is OPTIONAL and SHOULD contain a \sbol{URI} from \ref{tbl:combinatorialderivation_strategies}.
\\ Reference: \sec{sec:CombinatorialDerivation}}
...
\ref{tbl:variableComponent_operator}.
\\ Reference: \sec{sec:VariableComponent}}
...
\printComplete{\sbol{VariableComponent} objects MUST NOT form circular reference chains via their \sbol{variantDerivations} properties and parent \sbol{ComponentDerivation} objects.
\\ Reference: \sec{sec:VariableComponent}}

%% CHRIS: YIKES!  Do we really want to check this?  If so, I think there needs to be a good example in the specification.
\printComplete{If the \sbol{wasDerivedFroms} property of a \sbol{ComponentDefinition} refers to a \sbol{CombinatorialDerivation} and the \sbol{wasDerivedFrom} property of a \sbol{Component} contained by the \sbol{ComponentDefinition} refers to a \sbol{Component} contained by the template \sbol{ComponentDefinition} of the \sbol{CombinatorialDerivation}, then the \sbol{definition} property of the first \sbol{Component} MUST refer to a \sbol{ComponentDefinition} that is referred to by the \sbol{variants} or \sbol{variantCollections} properties of the \sbol{VariableComponent} with a \sbol{variable} property that refers to the second \sbol{Component}. Alternatively, the \sbol{definition} property of the first \sbol{Component} MUST refer to a \sbol{ComponentDefinition} with a \sbol{wasDerivedFroms} property that refers to a \sbol{CombinatorialDerivation} that is referred to by the \sbol{variantDerivations} property of the \sbol{VariableComponent}. If no such \sbol{VariableComponent} exists, then the \sbol{definition} property of the first \sbol{Component} MUST refer to the \sbol{ComponentDefinition} that is referred to by the \sbol{definition} property of the second \sbol{Component}.
\\ Reference: \sec{sec:VariableComponent}}
...
\printValid{An \sbol{Attachment} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{source}, \sbol{format}, \sbol{size}, and \sbol{hash}.\\ Reference: \sec{sec:Attachment}}
%A \sbol{Model} MUST inherit all properties of the \sbol{TopLevel} class.

\printValid{The \sbol{source} property of an \sbol{Attachment} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:Attachment}}

\printWarning{The \sbol{URI} contained by the \sbol{source} property of an \sbol{Attachment} MUST specify the location of the model's source file.\\ Reference: \sec{sec:Attachment}}
