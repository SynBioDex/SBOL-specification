...
\printModeling{If a \sbol{Feature} has an \sbolmult{orientation:F}{orientation} property, its \sbol{URI} SHOULD be drawn from \ref{tbl:orientation_types}.\\ Reference: \sec{sec:Feature}}
...
\printModeling{If a \sbol{Location} has an \sbolmult{orientation:L}{orientation} property, its \sbol{URI} SHOULD be drawn from \ref{tbl:orientation_types}.\\ Reference: \sec{sec:Location}}
