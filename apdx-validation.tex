...
\twotwozero{
\printComplete{\sbol{TopLevel} objects MUST NOT form circular reference chains via their \twooneone{\sbol{wasGeneratedBy}} properties.\\ Reference: \sec{sec:wasGeneratedBys}}
}
...
\printValid{An \sbol{Activity} with a child \sbol{Association} given a \sbol{roles} value of \sbol{sbol:design} MUST NOT have child \sbol{Usages} with \sbol{roles} other than \sbol{sbol:learn} or \sbol{sbol:design}.\\ Reference: \sec{sec:Activity}}

\printValid{An \sbol{Activity} with a child \sbol{Association} given a \sbol{roles} value of \sbol{sbol:build} MUST NOT have child \sbol{Usages} with \sbol{roles} other than \sbol{sbol:design} or \sbol{sbol:build}.\\ Reference: \sec{sec:Activity}}

\printValid{An \sbol{Activity} with a child \sbol{Association} given a \sbol{roles} value of \sbol{sbol:test} MUST NOT have child \sbol{Usages} with \sbol{roles} other than \sbol{sbol:build} or \sbol{sbol:test}.\\ Reference: \sec{sec:Activity} }

\printValid{An \sbol{Activity} with a child \sbol{Association} given a \sbol{roles} value of \sbol{sbol:learn} MUST NOT have child \sbol{Usages} with \sbol{roles} other than \sbol{sbol:test} or \sbol{sbol:learn}.\\ Reference: \sec{sec:Activity}}

\printModeling{It is RECOMMENDED that a \sbol{Usage} with \sbol{roles} of \sbol{sbol:design} SHOULD refer to a ModuleDefinition, ComponentDefinition, or Sequence.\\ Reference: \sec{sec:Usage}}

\printModeling{It is RECOMMENDED that a \sbol{Usage} with \sbol{roles} of \sbol{sbol:build} SHOULD refer to an Implementation.\\ Reference: \sec{sec:Usage}}

\printModeling{It is RECOMMENDED that a \sbol{Usage} with \sbol{roles} of \sbol{sbol:test} refer to an \sbol{Attachment} or \sbol{Collection} of \sbol{Attachments} which refer to files containing raw, experimental data.\\ Reference: \sec{sec:Usage}}

\printModeling{It is RECOMMENDED that a \sbol{Usage} with \sbol{roles} of \sbol{sbol:learn} SHOULD refer to a Model derived from fitting experimental data, a consensus \sbol{Sequence} derived from sequence analysis of a construct, or \sbol{Attachments} that reference files containing analyzed data (including graphs and tables).\\ Reference: \sec{sec:Usage}}
}
...
\printValid{An \sbol{Implementation} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{roles}, and \sbol{built}.\\ Reference: \sec{sec:implementation}}
