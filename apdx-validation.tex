...
\printValid{The \sbol{wasDerivedFrom} property of an \sbol{Identified} object is OPTIONAL and MAY contain \twooneone{a set of \sbol{URI}s}.  \\ Reference: \sec{sec:Identified}}
...
\sbol{annotations}, \sbolmult{types:CD}{types}, \sbolmult{types:CD}{roles}, \sbol{components}, \sbol{sequences}, \sbol{sequenceAnnotations}, and\\
\sbol{sequenceConstraints}.\\ Reference: \sec{sec:ComponentDefinition}}
...
\sbol{identity},\\
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description},\\
\sbol{annotations}, and \sbol{orientation}.\\
Reference: \sec{sec:GenericLocation}}
