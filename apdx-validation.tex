...
\printValid{The \sbol{local} property of a \sbol{MapsTo} that is contained by a \sbol{ComponentDefinition}the  is a REQUIRED \sbol{URI} that MUST reference a \sbol{Component} that is specified within the same \sbol{ComponentDefinition}. (Reference: \sec{sec:MapsTo})}
