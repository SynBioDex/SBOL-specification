...
\twothreezero{
\printValid{The \sbolmult{measures:C}{measures} property of a \sbol{ComponentInstance} is OPTIONAL and may contain a set of \sbol{Measure} objects.
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{hasNumericalValue}, \sbol{hasUnit}, and \sbol{types}.\\ Reference: \sec{sec:Measure}}
...
\printValid{The \sbol{hasUnit} property of a \sbol{Measure} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:Measure}}
...
\printComplete{The \sbol{URI} contained by the \sbol{hasUnit} property of a \sbol{Measure} MUST refer to a \sbol{Unit}.
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, \sbol{hasUnit}, and \sbol{hasFactor}.\\ Reference: \sec{sec:SingularUnit}}

\printValid{The \sbol{hasUnit} property of a \sbol{SingularUnit} is OPTIONAL and MAY contain a \sbol{URI}.\\ Reference: \sec{sec:SingularUnit}}
...
\printValid{Any \sbol{URI} contained by the \sbol{hasUnit} property of a \sbol{SingularUnit} MUST NOT be identical to the \sbol{URI} contained by its \sbol{identity} property.\\ Reference: \sec{sec:SingularUnit}}
...
\printComplete{The \sbol{URI} contained by the \sbol{hasUnit} property of a \sbol{SingularUnit} MUST refer to a \sbol{Unit}.
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, \sbol{hasTerm1}, and \sbol{hasTerm2}.\\ Reference: \sec{sec:UnitMultiplication}}
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, \sbol{hasNumerator}, and \sbol{hasDenominator}.\\ Reference: \sec{sec:UnitDivision}}
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, \sbol{hasBase}, and \sbol{hasExponent}.\\ Reference: \sec{sec:UnitExponentiation}}
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, \sbol{hasUnit}, and \sbol{hasPrefix}.\\ Reference: \sec{sec:PrefixedUnit}}

\printValid{The \sbol{hasUnit} property of a \sbol{PrefixedUnit} is REQUIRED and MUST contain a \sbol{URI}.\\ Reference: \sec{sec:PrefixedUnit}}
...
\printValid{The \sbol{URI} contained by the \sbol{hasUnit} property of a \sbol{PrefixedUnit} MUST NOT be identical to the \sbol{URI} contained by its \sbol{identity} property.\\ Reference: \sec{sec:PrefixedUnit}}

\printComplete{The \sbol{URI} contained by the \sbol{hasUnit} property of a \sbol{PrefixedUnit} MUST refer to a \sbol{Unit}.
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, and \sbol{hasFactor}.\\ Reference: \sec{sec:SIPrefix}}
}
...
\sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFroms}, \sbol{wasGeneratedBys}, \sbol{name},\\
\sbol{description}, \sbol{annotations}, \sbol{attachments}, \sbol{symbol}, \sbol{alternativeSymbols}, \sbol{label},\\
\sbol{alternativeLabels}, \sbol{comment}, \sbol{longcomment}, and \sbol{hasFactor}.\\ Reference: \sec{sec:BinaryPrefix}}
}
