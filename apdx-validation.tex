...
\twoonezero{
\printValid{A \sbol{SequenceAnnotation} MUST NOT have properties other than the following: \sbol{identity}, \sbol{persistentIdentity}, \sbol{displayId}, \sbol{version}, \sbol{wasDerivedFrom}, \sbol{name}, \sbol{description}, \sbol{annotations}, \sbol{component}, \sbol{locations}, \sbolmult{roles:SA}{roles}, and \sbolmult{roleIntegration:SA}{roleIntegration}.\\ Reference: \sec{sec:SequenceAnnotation}}
...
\twoonezero{
\printWarning{Each \sbol{URI} contained by the \sbolmult{roles:SA}{roles} property of a \sbol{SequenceAnnotation} MUST refer to an ontology term that is consistent with the  \sbolmult{types:CD}{types} property of the \sbol{ComponentDefinition} referred to by the \sbolmult{definition:CI}{definition} property of the \sbol{Component} specified in the \sbol{component} property of this \sbol{SequenceAnnotation}.\\ Reference: \sec{sec:SequenceAnnotation}}
}
...
\twoonezero{
\printModeling{
The \sbolmult{roles:SA}{roles} property of a \sbol{SequenceAnnotation} SHOULD NOT contain a \sbol{URI} that refers to a term from the sequence feature branch of the SO unless the  \sbolmult{types:CD}{types} property of the \sbol{ComponentDefinition} referred to by the \sbolmult{definition:CI}{definition} property of the \sbol{Component} specified in the \sbol{component} property of this \sbol{SequenceAnnotation} contains the DNA or RNA type \sbol{URI} listed in \ref{tbl:componentdefinition_types}.
\\ Reference: \sec{sec:SequenceAnnotation}}
}

\twoonezero{
\printModeling{If the \sbolmult{types:CD}{types} property of the \sbol{ComponentDefinition} referred to by the \sbolmult{definition:CI}{definition} property of the \sbol{Component} specified in the \sbol{component} property of this \sbol{SequenceAnnotation} contains the DNA or RNA type \sbol{URI}, then its \sbolmult{roles:SA}{roles} property SHOULD contain no more than one \sbol{URI} that refers to a term from the sequence feature branch of the SO.\\ 
Reference: \sec{sec:SequenceAnnotation}}
}

\twoonezero{
\printValid{The \sbolmult{roleIntegration:C}{roleIntegration} property of a \sbol{SequenceAnnotation}, if provided, MUST contain a \sbol{URI} from \ref{tbl:sequenceAnnotation_roleIntegration}.
\\ Reference: \sec{sec:SequenceAnnotation}}
}

\twoonezero{
\printValid{The \sbolmult{roleIntegration:C}{roleIntegration} property of a \sbol{SequenceAnnotation} is REQUIRED, if \sbolmult{roles:SA}{roles} property includes one or more roles.
\\ Reference: \sec{sec:SequenceAnnotation}}
}
