...
\printValid{The \sbol{types} property is a set of URIs, and it is REQUIRED to include at least one entry. (Reference: \sec{sec:ComponentDefinition})}
...
\printValid{The \sbol{types} property is a set of URIs, and it is REQUIRED to include at least one entry. (Reference: \sec{sec:Interaction})}
